...
@Uninterruptible public class Memory extends org.mmtk.vm.Memory
  ...
  protected final int getMaxBytesPaddingConstant() { return VM_SizeConstants.BYTES_IN_QUAD; }
  ...
  protected final byte getMaxAlignmentShiftConstant() { 
  	if (VM.SubArchCellSpu) {
  		// quad word alignment for cell spu's
  		return BYTES_IN_QUAD;
  	} else {
  		return (VM.BuildForIA32 ? 1 : 0) + VM_SizeConstants.LOG_BYTES_IN_LONG - VM_SizeConstants.LOG_BYTES_IN_INT;
  	}
  }
