...
@Uninterruptible public class Log implements Constants {
   ...
   * @param a the address to be logged
   */
  public static void write(LocalAddress a) {
    writeHex(a.toWord(), BYTES_IN_ADDRESS);
  }
   ...
   * @param a the address to be logged
   */
  public static void writeln(LocalAddress a) { writeln(a, true); }
   ...
   * @param flush if <code>true</code> then flushes the buffer
   */
  public static void writeln(LocalAddress a, boolean flush) {
    write(a);
    writelnWithFlush(flush);
  }
   ...
   * @param a the Address to be logged
   */
  public static void writeln(String s, LocalAddress a) {
    write(s);
    writeln(a);
  }
