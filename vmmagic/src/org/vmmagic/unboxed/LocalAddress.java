...
/**
 * <b>Stub</b> implementation of an LocalAddress type, intended only to
 * allow the core of MMTk to be compiled.  This <b>must</b> be
 * replaced with a concrete implementation appropriate to a specific
 * VM.
 *
 * The LocalAddress type is used by the runtime system and collector to
 * denote sub arch local machine addresses.  We use a separate type instead of the
