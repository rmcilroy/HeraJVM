...
static const int SUBARCH_PROCESSORS_INDEX      = PROCESSORS_INDEX+1;

static const int numNonstandardArgs      = SUBARCH_PROCESSORS_INDEX+1;
...
static const char* nonStandardUsage[] = {
   ...
   "    -X:subarchProcessors=<number|\"all\">  no. of subarch processors",
