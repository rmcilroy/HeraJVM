...
public final class VM_AbstractMethod extends VM_Method {
   ...
   */
  VM_AbstractMethod(VM_TypeReference declaringClass, VM_MemberReference memRef, short modifiers, short annoModifiers,
   ...
   */
  protected VM_CompiledMethod genCode(boolean forSubArch) {
    VM_Entrypoints.unexpectedAbstractMethodCallMethod.compile(forSubArch);
    return VM_Entrypoints.unexpectedAbstractMethodCallMethod.getCurrentCompiledMethod(forSubArch);
  }
}
