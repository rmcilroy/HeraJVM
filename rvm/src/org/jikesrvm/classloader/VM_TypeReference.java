...
public final class VM_TypeReference {
  ...
  public static final VM_TypeReference LocalAddress = findOrCreate(org.vmmagic.unboxed.LocalAddress.class);
  ...
  public static final VM_TypeReference SubArchCode =
    	VM.HybridRVM ? findOrCreate("Lorg/jikesrvm/cellspu/VM_Code;") : Code;
  ...
  public static final VM_TypeReference CodeArray = 
  	findOrCreate(org.jikesrvm.ArchitectureSpecific.VM_CodeArray.class);
  public static final VM_TypeReference CodeArrayDirect = findOrCreate(VM.BuildForIA32 ? "Lorg/jikesrvm/ia32/VM_CodeArray;" : "Lorg/jikesrvm/ppc/VM_CodeArray;");
  public static final VM_TypeReference SubArchCodeArray = findOrCreate(org.jikesrvm.SubordinateArchitecture.VM_CodeArray.class);
  public static final VM_TypeReference SubArchCodeArrayDirect = findOrCreate(org.jikesrvm.cellspu.VM_CodeArray.class);
  public static final VM_TypeReference AbstractCodeArray = findOrCreate(org.jikesrvm.VM_CodeArray.class);
  ...
  public static final VM_TypeReference JavaLangArrayIndexOutOfBoundsException =
  ...
  public static final VM_TypeReference JavaLangNegativeArraySizeException =
      findOrCreate(java.lang.NegativeArraySizeException.class);
  public static final VM_TypeReference JavaLangIllegalMonitorStateException =
  ...
  public static final VM_TypeReference LogicallyUninterruptible =
  ...
  public static final VM_TypeReference UninterruptibleNoWarn =
  ...
  public static final VM_TypeReference VALIDATION_TYPE =
      (VM.BuildForOptCompiler) ? findOrCreate("Lorg/jikesrvm/classloader/VM_TypeReference$VALIDATION;") : null;
  ...
  public VM_TypeReference getArrayElementType() {
    ...
    if (isUnboxedArrayType()) {
      if (this == AddressArray) {
        ...
        return Code;
      } else if (isSubArchCodeArrayType()) {
        return SubArchCode;
      } else if (isAbstractCodeArrayType()) {
        if (VM.runningVM) VM._assert(false, "Unexpected unboxing of AbstractCodeArray!");
        return Code;
      } else {
  ...
  public boolean isWordType() {
    return this == Word || this == Offset || this == Address || this == LocalAddress || this == Extent;
  }
  ...
  public boolean isUnboxedType() {
    return isWordType() || isCodeType() || isSubArchCodeType();
  }
  ...
  /**
   * Does 'this' refer to VM_SubArchCode
   */
  @Uninterruptible
  public boolean isSubArchCodeType() {
    return this == SubArchCode;
  }
  ...
  public boolean isUnboxedArrayType() {
    return isWordArrayType() || isCodeArrayType() || isSubArchCodeArrayType() || isAbstractCodeArrayType() || this == ObjectReferenceArray;
  }
  ...
  /**
   * Does 'this' refer to VM_SubArchCodeArray
   */
  @Uninterruptible
  public boolean isSubArchCodeArrayType() {
  	return this == SubArchCodeArray;
  }

  /**
   * Does 'this' refer to VM_AbstractCodeArray
   */
  @Uninterruptible
  public boolean isAbstractCodeArrayType() {
    return this == AbstractCodeArray;
  }
  ...
  public boolean isLoaded(boolean forSubArch) {
  	if (forSubArch) {
  		return type != null && type.isLoaded(forSubArch);
  	} else {
  		return type != null;
  	}
  }
  ...
  public boolean isResolved(boolean forSubArch) {
    return isLoaded(forSubArch) && type.isResolved(forSubArch);
  }
   ...
   *        This stinks. XXX)
   */
  public VM_Type resolve(boolean forSubArch) throws NoClassDefFoundError, IllegalArgumentException {
    /*
    ...
    */
    synchronized (classloader) {
      return resolveInternal(forSubArch);
    }
  }

  private VM_Type resolveInternal(boolean forSubArch) throws NoClassDefFoundError, IllegalArgumentException {
    if (type != null && !forSubArch) return type;
    if (type != null && forSubArch) {
    	type.load(forSubArch);
    	type.resolve(forSubArch);
    	return type;
    }
    if (isClassType()) {
      VM_Type ans;
      ...
      if (isUnboxedArrayType()) {
        ...
        setType(getArrayElementType().getArrayTypeForElementType().resolve(forSubArch));
      } else {
        VM_Type elementType = getArrayElementType().resolve(forSubArch);
        if (elementType.getClassLoader() != classloader) {
          ...
          setType(canonical.resolve(forSubArch));
        } else {
