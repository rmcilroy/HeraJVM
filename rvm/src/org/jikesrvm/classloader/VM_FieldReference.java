...
public final class VM_FieldReference extends VM_MemberReference implements VM_SizeConstants {
  ...
  public boolean definitelyDifferent(VM_FieldReference that) {
    ...
    VM_Field mine = peekResolvedField(false);
   ...
   */
  public VM_Field peekResolvedField(boolean forSubArch) {
   ...
   */
  public synchronized VM_Field resolve(boolean forSubArch) {
    if (resolvedMember != null) return resolvedMember;
  ...
  private VM_Field resolveInternal(VM_Class declaringClass, boolean forSubArch) {
