...
public final class VM_Primitive extends VM_Type implements VM_Constants, VM_ClassLoaderConstants {
    ...
    switch (tr.getName().parseForTypeCode()) {
      ...
      default:
        if (tr == VM_TypeReference.Address ||
        		tr == VM_TypeReference.LocalAddress ||
          ...
          name = tr.getName();
          classForType = null;
        } else if (tr == VM_TypeReference.SubArchCode) {
          stackWords = 1;
          memoryBytes = BYTES_IN_INT;
          name = tr.getName();
          classForType = null;
   ...
   */
  public void resolve(boolean forSubArch) {}
   ...
   * Cause instantiation to take place.
   */
  public void instantiate(boolean forSubArch) {}
