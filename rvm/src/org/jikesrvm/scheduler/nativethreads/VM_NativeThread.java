...
public class VM_NativeThread extends VM_Thread {
   ...
   * isn't set.
   */
  public VM_NativeThread(Thread thread, long stacksize, String name, boolean daemon, int priority, boolean forSubArch) {
   ...
   * Create a thread.
   */
  protected VM_NativeThread(byte[] stack, Thread thread, String name, boolean daemon, boolean system, int priority, boolean forSubArch) {
