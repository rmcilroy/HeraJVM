...
public interface VM_SizeConstants {
  ...
  int LOG_BYTES_IN_QUAD= 4;
  int BYTES_IN_QUAD = 1 << LOG_BYTES_IN_QUAD;
  int LOG_BITS_IN_QUAD = LOG_BITS_IN_BYTE + LOG_BYTES_IN_QUAD;
  int BITS_IN_QUAD = 1 << LOG_BITS_IN_QUAD;
