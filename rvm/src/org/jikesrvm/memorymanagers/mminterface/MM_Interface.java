...
public final class MM_Interface implements VM_HeapLayoutConstants, Constants {
  ...
  */
  ...
  /**
   * Private allocation of code array 
   * 
   ...
   */
  @Interruptible
  private static Object _allocateCode(VM_Array type, int numInstrs, boolean isHot) {
    ...
    return allocateArray(numInstrs, width, headerSize, tib, allocator, align, offset, Plan.DEFAULT_SITE);
  }
  ...
  public static VM_CodeArray allocateCode(int numInstrs, boolean isHot) {
    VM_Array type = VM_Type.CodeArrayType;
  	return (VM_CodeArray) _allocateCode(type, numInstrs, isHot);
  }

  /**
   * Allocate a  SubordianteArchitecture VM_CodeArray into a code space.
   * Currently the interface is fairly primitive;
   * just the number of instructions in the code array and a boolean
   * to indicate hot or cold code.
   * @param numInstrs number of instructions
   ...
   */
  @Interruptible
  public static org.jikesrvm.SubordinateArchitecture.VM_CodeArray allocateCodeSubArch(int numInstrs, boolean isHot) {
    VM_Array type = VM_Type.SubArchCodeArrayType;
  	return (org.jikesrvm.SubordinateArchitecture.VM_CodeArray) _allocateCode(type, numInstrs, isHot);
  }
