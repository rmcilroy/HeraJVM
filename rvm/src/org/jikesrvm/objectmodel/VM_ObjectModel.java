...
public class VM_ObjectModel implements VM_JavaHeaderConstants, VM_SizeConstants {
  ...
  public static Address allocateScalar(BootImageInterface bootImage, VM_Class klass) {
    ...
    VM_MiscHeader.initializeHeader(bootImage, ref, tib, size, klass, true);
    return ref;
  }
  ...
  public static Address allocateArray(BootImageInterface bootImage, VM_Array array, int numElements) {
    ...
    VM_MiscHeader.initializeHeader(bootImage, ref, tib, size, array, false);
    return ref;
  }
  ...
  public static void baselineEmitLoadTIB(VM_AbstractAssembler asm, int dest, int object, boolean forSubArch) {
    VM_JavaHeader.baselineEmitLoadTIB(asm, dest, object, forSubArch);
  }
}
