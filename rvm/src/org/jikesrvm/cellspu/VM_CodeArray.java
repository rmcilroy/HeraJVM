...
public abstract class VM_CodeArray extends org.jikesrvm.VM_CodeArray {
  ...
  public Object getBacking() {
    if (!(VM.writingImage || VM.writingBootImage)) VM.sysFail("VM_CodeArray.getBacking called when not writing boot image");
    return data;
  }
  ...
  public static class Factory {
     ...
     */
    public static SubordinateArchitecture.VM_CodeArray create(int numInstrs, boolean isHot) {
      if (VM.runningVM) {
        return MM_Interface.allocateCodeSubArch(numInstrs, isHot);
      } else {
        return SubordinateArchitecture.VM_CodeArray.create(numInstrs);
      }
    }
  }
}
