...
public class VM_MagicNames {
  ...
  public static final VM_Atom invokeMethodReturningDouble =
      VM_Atom.findOrCreateAsciiAtom("invokeMethodReturningDouble");
  public static final VM_Atom invokeMethodReturningObject =
      VM_Atom.findOrCreateAsciiAtom("invokeMethodReturningObject");
  ...
  public static final VM_Atom getSubArchJTOC = VM_Atom.findOrCreateAsciiAtom("getSubArchJTOC");
  ...
  public static final VM_Atom runningOnSubArch = VM_Atom.findOrCreateAsciiAtom("runningOnSubArch");
  ...
  public static final VM_Atom loadLocalAddress = VM_Atom.findOrCreateAsciiAtom("loadLocalAddress");
  ...
  public static final VM_Atom restoreHardwareExceptionState =
      VM_Atom.findOrCreateAsciiAtom("restoreHardwareExceptionState");
  ...
  public static final VM_Atom localAddressAsObject = VM_Atom.findOrCreateAsciiAtom("localAddressAsObject");
  public static final VM_Atom objectAsLocalAddress = VM_Atom.findOrCreateAsciiAtom("objectAsLocalAddress");
  public static final VM_Atom addressAsObject = VM_Atom.findOrCreateAsciiAtom("addressAsObject");
  public static final VM_Atom addressAsLocalAddress = VM_Atom.findOrCreateAsciiAtom("addressAsLocalAddress");
  public static final VM_Atom localAddressAsAddress = VM_Atom.findOrCreateAsciiAtom("localAddressAsAddress");
  ...
  /* Cell SPU specific */
  public static final VM_Atom readIntMailBox = VM_Atom.findOrCreateAsciiAtom("readIntMailBox");
  public static final VM_Atom readRefMailBox = VM_Atom.findOrCreateAsciiAtom("readRefMailBox");
  public static final VM_Atom writeMailBox = VM_Atom.findOrCreateAsciiAtom("writeMailBox");
  public static final VM_Atom writeMailBoxUpperWord = VM_Atom.findOrCreateAsciiAtom("writeMailBoxUpperWord");
  public static final VM_Atom writeMailBoxLowerWord = VM_Atom.findOrCreateAsciiAtom("writeMailBoxLowerWord");
  public static final VM_Atom writeIntrMailBox = VM_Atom.findOrCreateAsciiAtom("writeIntrMailBox");
  public static final VM_Atom cacheStaticMethod = VM_Atom.findOrCreateAsciiAtom("cacheStaticMethod");
  public static final VM_Atom cacheClassStatics = VM_Atom.findOrCreateAsciiAtom("cacheClassStatics");
  ...
  public static final VM_Atom wordToLocalAddress = VM_Atom.findOrCreateAsciiAtom("toLocalAddress");
  ...
  public static final VM_Atom addressArrayGetBacking = VM_Atom.findOrCreateAsciiAtom("getBacking");
}
