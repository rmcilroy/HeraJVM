...
public class VM_Math {
   ...
   */
	@Entrypoint
	static final long Long2DoubleShfCtrl = 0x0203101112138080L;
	@Entrypoint
	static final long Long2DoubleShfCtrl2 = 0x0607141516178080L;
  @Entrypoint
  ...
  @Entrypoint
  static final double Long2DoubleExpDef = Double.longBitsToDouble(0x0000043e0000041eL);
  @Entrypoint
